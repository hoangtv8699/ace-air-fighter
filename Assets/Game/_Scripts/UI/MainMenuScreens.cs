...
public class MainMenuScreens : MonoBehaviour
{
		...
		;
		public GameObject MainMenuParent, PlayerSelectionParent,  
				ByPopupMenuParent, UnSufficentCoinsMenuParent, UnsufficentCoinsForPlayerselectionMenu, TotalCoinsParent;
